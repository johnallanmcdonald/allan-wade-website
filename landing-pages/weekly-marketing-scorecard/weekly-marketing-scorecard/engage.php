...
<head>
  ...
  <title>Engage with Us | The Allan Wade Company</title>
...
<div class="container jf-form">
  <h1>Engage with The Allan Wade Company</h1>
  <p class="lead">You are one step closer to putting your sales into high gear!</p>
</div>
<div class="container jf-form">
...
<div class="form-group c42 required" data-cid="c42">
  <label class="control-label" for="c42">Phone</label>

<div class="input-group"><span class="input-group-addon left"><i class="glyphicon glyphicon-earphone"></i> </span>
<input type="tel" class="form-control" id="c42" name="c42" value=""   placeholder="xxx-xxx-xxxx" 
...
<div class="form-group c36 required" data-cid="c36">
  <label class="control-label" for="c36">Web Link</label>


<input type="url" class="form-control" id="c36" name="c36" value=""  aria-describedby="c36-help-block" placeholder="http://" 
    data-rule-url="true" 
    data-rule-required="true"  />



  <p id="c36-help-block" class="description">Provide us with your website so that we can start reviewing it right away.</p>
...
<div class="form-group c3 required" data-cid="c3">
  <label class="control-label" for="c3">Comments</label>

<div class="input-group"><span class="input-group-addon left"><i class="glyphicon glyphicon-edit"></i> </span>
<textarea class="form-control" id="c3" name="c3" rows="3" aria-describedby="c3-help-block"  
    data-rule-required="true" ></textarea>
</div>

  <p id="c3-help-block" class="description">Tell us as much or as little as you would like to.</p>
